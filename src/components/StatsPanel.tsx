...
export function StatsPanel(props: StatsPanelProps) {
  return (
    <div class="flex flex-col gap-6">
      <div>
        <p class="text-sm uppercase tracking-wider text-neutral-400">Daily Density</p>
        <p
        ...
        <p class="mt-1 text-xs text-neutral-500">Across all waking cycles (6-E)</p>
      </div>

      <div>
        <p class="text-sm uppercase tracking-wider text-neutral-400">Current Streak</p>
        <p
